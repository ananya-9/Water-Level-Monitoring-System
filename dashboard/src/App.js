 ...
 fetch('http://'+ip+'/dashboard/get_latest_water_level/')
  ...
  .then(data => data['state']).then(
    ...
    //console.log(data)
      ...
      fetch('http://'+ip+'/dashboard/get_motor_usage/1-0')
      .then(response => response.json())
      .then(data => data['units']).then(
         data => this.setState({motor_usage: data*1000}))

         fetch('http://'+ip+'/dashboard/get_water_usage/1-0')
         .then(response => response.json())
         .then(data => data['usage']).then(
            data => this.setState({water_usage: data}))

  fetch('http://'+ip+'/dashboard/get_last_day_water_levels/1-0')
       ...
       <div className="guage"> 
        ...
        <div className="card dashboardPanel">
          ...
          <div className="card-body"  >
            ...
            <h5 className="card-title">Water Usage</h5>
          
              <div className="motor_state_box" >
              <Box color="white" bgcolor="#002244" p={2} height='348px' >
                    <center><h1>{this.state.water_usage.toFixed(4)} tanks</h1></center>
                </Box>
              </div>
            </div>
          </div>
        ...
        <div className="card dashboardPanel">
          ...
          <div className="card-body"  >
            ...
            <h5 className="card-title">Pump Status</h5>
